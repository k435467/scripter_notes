...
title: Drawing Game
authors: ethan
tags: [drawing, game, lottery, spin wheel]
---

Use a [easing functions](https://easings.net/) and setTimeout to build a drawing highlight effect.

<!--truncate-->

import DrawingGame from '@site/src/components/DrawingGame';
